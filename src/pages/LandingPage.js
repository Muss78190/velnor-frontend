...
const VelnorLanding = () => {
      ...
      if (progress >= 100) {
        ...
        setTimeout(() => {
          if (loaderRef.current) {
            ...
            loaderRef.current.style.transform = 'scale(0.8) rotateY(180deg)';
  ...
  const handleMouseMove = useCallback((e) => {
    ...
    if (glowOrbRef.current) {
      glowOrbRef.current.style.transform = `translate(${e.clientX - 10}px, ${e.clientY - 10}px)`;
    }
